...
void CMelee_Effect::Update(_float fTimeDelta)
{
	...
	switch (m_playerID)
	{
	case CMelee_Effect::PLAYERID::PLAYER_1P:
		group = CCollider_Manager::CG_1P_Energy_Attack;
		break;
	case CMelee_Effect::PLAYERID::PLAYER_2P:
...
void CMelee_Effect::Make_Collider(CCollider_Manager::COLLIDERGROUP eColliderGroup, _float2 SourcePos, _float2 DestPos)
{
