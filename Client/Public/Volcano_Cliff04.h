...
class CVolcano_Cliff04 final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Cliff04(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Cliff04(const CVolcano_Cliff04& Prototype);
	virtual ~CVolcano_Cliff04() = default;
...
public:
	static CVolcano_Cliff04* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
