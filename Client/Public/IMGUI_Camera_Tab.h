...
class CIMGUI_Camera_Tab : public CIMGUI_Tab
{
	...
	//모델은 정해져있음
	enum CAMERA_MODELID { CAMERA_MODELID_NOT = -1, CAMERA_MODELID_NORMAL, CAMERA_MODELID_FREE, CAMERA_MODELID_MAP, CAMERA_MODELID_SON, CAMERA_MODELID_21, CAMERA_MODELID_HIT, CAMERA_MODELID_MINE, CAMERA_MODELID_END };
