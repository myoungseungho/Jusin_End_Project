...
class CVolcano_Cliff_Back final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Cliff_Back(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Cliff_Back(const CVolcano_Cliff_Back& Prototype);
	virtual ~CVolcano_Cliff_Back() = default;
...
public:
	static CVolcano_Cliff_Back* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
