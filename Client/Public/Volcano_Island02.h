...
class CVolcano_Island02 final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Island02(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Island02(const CVolcano_Island02& Prototype);
	virtual ~CVolcano_Island02() = default;
...
public:
	static CVolcano_Island02* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
