...
namespace Client
{
	...
	const static enum CHARACTER_INDEX {
		SELECT_GOKU=0, SELECT_BOU, SELECT_21, SELECT_HIT,
		PLAY_GOKU,  PLAY_BOU, PLAY_21, PLAY_HIT, 
		OPENING_GOKU, OPENIING_21, SKILL_GOKU, CHARACTER_INDEX_END
	};

	const static enum HitMotion { HIT_LIGHT, HIT_CHASE, HIT_MEDIUM, HIT_HEAVY, HIT_HEAVY_DOWN, HIT_CROUCH_MEDIUM, HIT_KNOCK_AWAY_LEFT, HIT_KNOCK_AWAY_LEFT_NONEBOUNDE, HIT_KNOCK_AWAY_UP, HIT_KNOCK_AWAY_LEFTDOWN, HIT_SPIN_AWAY_LEFTUP, HIT_SPIN_AWAY_UP,HIT_WALLBOUNCE, HIT_NONE};
