...
class CEnergy_Effect_2p final : public CGameObject
{
public:
	enum class PLAYERID
	{
...
private:
	CEnergy_Effect_2p(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnergy_Effect_2p(const CEnergy_Effect_2p& Prototype);
	virtual ~CEnergy_Effect_2p() = default;
...
public:
	static CEnergy_Effect_2p* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
