...
class CVolcano_Cliff01 final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Cliff01(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Cliff01(const CVolcano_Cliff01& Prototype);
	virtual ~CVolcano_Cliff01() = default;
...
public:
	static CVolcano_Cliff01* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
