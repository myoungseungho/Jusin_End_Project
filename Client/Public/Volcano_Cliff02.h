...
class CVolcano_Cliff02 final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Cliff02(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Cliff02(const CVolcano_Cliff02& Prototype);
	virtual ~CVolcano_Cliff02() = default;
...
public:
	static CVolcano_Cliff02* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
