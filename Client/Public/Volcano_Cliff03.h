...
class CVolcano_Cliff03 final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Cliff03(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Cliff03(const CVolcano_Cliff03& Prototype);
	virtual ~CVolcano_Cliff03() = default;
...
public:
	static CVolcano_Cliff03* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
