...
class CVolcano_Island01 final : public CGameObject
{
public:
	enum Space_TextureType { SPACE_DIFFUSE,SPACE_STAR_1, SPACE_STAR_2, SPACE_END};

private:
	CVolcano_Island01(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVolcano_Island01(const CVolcano_Island01& Prototype);
	virtual ~CVolcano_Island01() = default;
...
public:
	static CVolcano_Island01* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
